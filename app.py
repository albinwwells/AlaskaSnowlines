...
with col2:
    st.download_button(
        label="Download regional files (e.g., glacier melt days, melt season start/end, subregion snow-free area fraction)",
        data=reg_zip,
...
st.markdown(
    ...
    Citation: Wells, A., Rounce, D., and Fahnestock, M. <i>"Seasonal progression of melt and snowlines 
    in Alaska from SAR reveals impacts of warming."</i> <i>Manuscript in review.</i> (2025).<br>
