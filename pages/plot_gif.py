...
if rgi_no is None:
    ...
    if animations:
        for pathrow, html_content in animations:
            ...
            st.components.v1.html(html_content, height=90*10, width=None, scrolling=True)
...
st.markdown(
    ...
    in Alaska from SAR reveals impacts of warming."</i> <i>Manuscript in prep.</i> (2025).<br>
